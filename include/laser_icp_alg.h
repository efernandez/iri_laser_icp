...
class LaserIcpAlgorithm
{
  ...
  public:
    ...
    * will then use the same variable type Config.
    */
    typedef iri_laser_icp::LaserIcpConfig Config;
    ...
    */
    ...
    // here define all laser_icp_alg interface methods to retrieve and set
